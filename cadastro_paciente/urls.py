...
urlpatterns = [
    ...
    path('editar/<int:idPaciente>/', views.editar, name='editar_t'),
    path('atualizar/<int:idPaciente>/', views.atualizar, name='atualizar_t'),
    path('deletar/<int:idPaciente>/', views.deletar, name='deletar_t'),
]